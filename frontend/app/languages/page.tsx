    ...
    <main className="min-h-screen bg-black p-6 text-white md:p-10">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-3xl text-white/50">
          Explorează conținut după limbă, țară, audio și subtitrări.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
        {countries.map((country) => (
          <Link
            key={country}
            href={`/discover/language-${slugify(country)}`}
          ...
          >
            ...
            <div className="mt-2 text-sm text-white/50">Catalog limbă / regiune</div>
          </Link>
        ))}
      </div>
    </main>
