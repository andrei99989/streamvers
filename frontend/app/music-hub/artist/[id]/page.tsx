...
export default function DeezerArtistPage({ params }: any) {
  const { id } = use(params);
            ...
            <div className="flex gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <a
                  href={track.link}
                  target="_blank"
                  className="mt-3 inline-flex items-center gap-2 rounded-2xl bg-white px-4 py-2 text-sm font-black text-black"
                >
                  <Play size={15} />
                  Deezer
                </a>
